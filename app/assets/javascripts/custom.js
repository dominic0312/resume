...
/////////////////* HINT */////////////////////////
                ...
                if ("ontouchstart" in document.documentElement) {
                    document.querySelector(".hint").innerHTML = "<span>向左或右滑动浏览</span>";
                }
...
function load() {
    ...
    var point = new BMap.Point(114.085213,22.821973);  // 创建点坐标
...
//    var point = new google.maps.LatLng(40.714353, -74.005973);
//
//    var myMapOptions = {
//        zoom: 15,
